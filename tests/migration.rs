...
fn build_v1_fixture(ctx: &TestContext) {
    ...
    let obs_a = r#"{"schema_version":1,"observation_id":"obs_a","store_id":"store_fix","local_sequence":1,"idempotency_key":"kia","created_at":"2026-01-02T00:00:00Z","source":{"kind":"agent_explicit"},"title":"A","sensitivity":"normal","context":{},"artifacts":[],"affected_repository_ids":[]}"#;
    let obs_b = r#"{"schema_version":1,"observation_id":"obs_b","store_id":"store_fix","local_sequence":2,"idempotency_key":"kib","created_at":"2026-01-01T00:00:00Z","source":{"kind":"agent_explicit"},"title":"B","sensitivity":"normal","context":{},"artifacts":[],"affected_repository_ids":[]}"#;
